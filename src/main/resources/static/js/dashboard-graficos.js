...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('empresas-prev-page').addEventListener('click', function() {
    ...
    document.getElementById('empresas-next-page').addEventListener('click', function() {
...
function cargarDatosEstadisticas(mostrarMensaje = false) {
    ...
    if (mostrarMensaje) {
        mostrarMensajeEstado('Actualizando datos...', 'info');
    }
...
function actualizarTablaEmpresas(empresas) {
    ...
    console.log('Empresas procesadas para mostrar:', empresasData);
    ...
    window.empresasData = empresasData;
...
function mostrarMensajeEstado(mensaje, tipo) {
    ...
    mensajeElemento.className = `status-message ${tipo}`;
    ...
    setTimeout(() => {
        mensajeElemento.classList.add('fadeOut');
        setTimeout(() => {
